...
void AboutDialog::setText(QString latestVersion) {
    ...
    ui.textBrowser->setHtml(QString("<b>%1 %2</b> (git %3)").arg(TEXSTUDIO,TXSVERSION,TEXSTUDIO_GIT_REVISION ? TEXSTUDIO_GIT_REVISION : "n/a") + "<br>" +
                            ...
                            tr("Project home site:") + " <a href=\"https://iguana.org/\">https://iguana.org/</a><br>" +
	                        ...
	                        tr("Iguana contains code from Hunspell (GPL), QtCreator (GPL, Copyright (C) Nokia), KILE (GPL) and SyncTeX (by Jerome Laurens).") + "<br>" +
	                        tr("Iguana uses the PDF viewer of TeXworks.") + "<br>" +
	                        tr("Iguana uses the DSingleApplication class (Author: Dima Fedorov Levit - Copyright (C) BioImage Informatics - Licence: GPL).") + "<br>" +
	                        tr("Iguana uses TexTablet (MIT License, Copyright (c) 2012 Steven Lovegrove).") + "<br>" +
	                        tr("Iguana uses QuaZip (LGPL, Copyright (C) 2005-2012 Sergey A. Tachenov and contributors).") + "<br>" +
	                        tr("Iguana uses To Title Case (MIT License, Copyright (c) 2008-2013 David Gouch).") + "<br>" +
	                        tr("Iguana contains an image by Alexander Klink.") + "<br>" +
	                        tr("Iguana uses icons from the Crystal Project (LGPL), the Oxygen icon theme (CC-BY-SA 3.0) and the Colibre icon theme (CC0) of LibreOffice.") + "<br>" +
	                        tr("Iguana uses flowlayout from Qt5.6 examples.") + "<br>" +
                            tr("Iguana uses adwaita-qt (GPL2) from ") + "<a href=\"https://github.com/FedoraQt/adwaita-qt\">https://github.com/FedoraQt/adwaita-qt</a><br>" +
	                        "<br>" +
